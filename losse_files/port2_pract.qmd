---
title: "pH-berekeningen: logaritmen en exponenten"
author: "Jouw naam"
format: 
  html:
    toc: true 
...
Op een lineaire schaal zouden verschillen in concentratie bovendien volledig wegvallen: tussen 
$[\ce{H^+}]=10^{−7}$ en $[\ce{H^+}]=10^{−7.5}$
zit een factor 5, maar op een lineaire schaal lijken die waarden bijna identiek. Biologisch weten we dat zulke verschillen wél relevant zijn.

Een logaritmische schaal lost dit op door in plaats van de concentratie, de exponent te noteren.Een concentratie met $pH = 7.34$ heeft dan een protonenconcentratie van 
$10^{−7.34}$ molair. Kleine veranderingen in de exponent worden dan direct zichtbaar als kleine veranderingen in de pH‑waarde.

Dat werkt omdat logaritmen vermenigvuldigingsfactoren omzetten in optelbare verschillen:

$$\log(ab)=\log(a) + \log(b).$$

Een factor 3 verschil in concentratie wordt zo een verschil van $\log(3)\approx 0.48$
in pH. Daardoor kunnen we subtiele, maar belangrijke variaties in zuurgraad veel nauwkeuriger beschrijven.
